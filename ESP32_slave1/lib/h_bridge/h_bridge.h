...
#define INPUT_LEFT_1    GPIO_NUM_23
#define INPUT_LEFT_2    GPIO_NUM_22
...
#define LEDC_OUTPUT_LEFT        GPIO_NUM_5 // Enable PWM A
#define LEDC_CHANNEL_LEFT       LEDC_CHANNEL_0

#define LEDC_OUTPUT_RIGHT       GPIO_NUM_18 // Enable PWM B 
